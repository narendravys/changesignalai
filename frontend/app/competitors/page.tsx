        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 font-medium">Active Tracking</p>
                  <p className="text-3xl font-bold text-green-600 mt-1">{activeCompetitors}</p>
                </div>
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 font-medium">Monitored Pages</p>
                  <p className="text-3xl font-bold text-purple-600 mt-1">{totalPages}</p>
                </div>
          ...
          {competitors.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Add Your First Competitor</h3>
            ...
            <>
              ...
              {filteredCompetitors.length === 0 ? (
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
                  <p className="text-gray-500 text-lg">No competitors match your search</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredCompetitors.map((competitor) => (
                    <div 
                      key={competitor.id} 
                      className="group bg-white rounded-2xl border-2 border-gray-100 hover:border-blue-300 hover:shadow-xl transition-all p-6"
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          ...
                          <a
                            ...
                            className="text-sm text-blue-600 hover:text-blue-700 flex items-center gap-2 font-medium mt-2"
                          >
                      ...
                      {/* Stats Bar */}
                      <div className="flex items-center justify-between py-3 px-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg mb-4 border border-blue-100">
                      ...
                      <div className="flex gap-2 pt-4 border-t border-gray-100">
                        <Link
                          ...
                          className="flex-1 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-all font-medium text-center flex items-center justify-center space-x-2"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 px-4 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-all font-medium flex items-center justify-center space-x-2"
                        >
            ...
            <div className="bg-white rounded-2xl max-w-md w-full p-8 shadow-2xl">
              ...
              <form onSubmit={handleAddCompetitor} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <FiGlobe className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                    <input
                      type="text"
                      className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:outline-none transition-colors bg-white text-gray-900 placeholder:text-gray-400"
                      value={domain}
